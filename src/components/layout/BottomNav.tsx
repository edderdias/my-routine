...
import { LayoutDashboard, CalendarDays, Plus, CheckSquare, Settings } from 'lucide-react';
...
export const BottomNav: React.FC = () => {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-lg border-t border-slate-200/80 px-2 py-1.5 pb-safe select-none shadow-lg">
      <div className="flex items-center justify-around max-w-md mx-auto">
        ...
        >
          ...
          {pendingCount > 0 && (
            <span className="absolute top-0 right-2 w-4 h-4 bg-blue-600 text-white rounded-full text-[9px] font-extrabold flex items-center justify-center">
